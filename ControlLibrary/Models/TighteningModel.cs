...
namespace ControlLibrary.Models
{
    ...
    public class TighteningModel
    {
        ...
        /// Specified by four digits ranging from 0000 to 9999.
        /// </summary>
        public string  BatchCount { get; set; } = string.Empty;
        ...
        /// </summary>
        public string TorqueStatus { get; set; } = string.Empty;

        /// <summary>
        /// The angle status specifies if the angle measurement is low (0), ok (1), or high (2).
        /// </summary>
        public string AngleStatus { get; set; } = string.Empty;
        ...
        /// </summary>
        public string TighteningId { get; set; } = string.Empty;
    }
}
